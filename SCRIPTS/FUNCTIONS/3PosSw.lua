...
TRIG1_IDX = 59				-- index of the 1st logical switch that trigger the script (up)
TRIG2_IDX = 60				-- index of the 2nd logical switch that trigger the script (down)

START_IDX = 61				-- index of the 1st logical switch in the multi-position-switch
