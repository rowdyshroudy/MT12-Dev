...
lcd.drawText (64,13, "DIG", INVERS)
lcd.drawText (59,40, "GEAR", INVERS)
...
--Dig Alert
local function DigAct()
  local digpos = getLogicalSwitchValue (7)
  if digpos == false then
  lcd.drawText (64,26, "Dis")
  end
  if digpos == true then
  lcd.drawText (64,26, "ACT")
  end
end
...
local function TwoSpeed()
  local gearpos = getLogicalSwitchValue (6)
  if gearpos == true then
  lcd.drawText (60,52, "HIGH")
  end
  if gearpos == false then
  lcd.drawText (63,52, "LOW")
  end
end
