...
--Dig control
local function dig()
local awdpos = getLogicalSwitchValue (61)
local fwdpos = getLogicalSwitchValue (62)
local digpos = getLogicalSwitchValue (63)
if awdpos == true then
lcd.drawText (95,52, "4WD")
end
if fwdpos == true then
lcd.drawText (95,52, "FWD")
end
if digpos == true then
lcd.drawText (95,52, "DIG")
end
end
