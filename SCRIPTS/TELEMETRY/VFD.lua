...
local odpos = getValue ("gvar3")
if odpos == -1024 then
lcd.drawText (30,26, "LOW")
end
if odpos == 0 then
lcd.drawText (30,39, "RWD")
end
if odpos == 1024 then
lcd.drawText (28,52, "HIGH")
end
end
...
if digpos == -1024 then
lcd.drawText (62,26, "4WD")
end
if digpos == 0 then
lcd.drawText (62,39, "FWD")
end
if digpos == 1024 then
lcd.drawText (60,52, "LOCK")
end
end

-- Winch
local function winch()
local winch = getOutputValue (3)
